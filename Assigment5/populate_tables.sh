...
insert into units_leased (id, renterid, rentfrom, rentto, priceperunit, unitid, totalprice) values ('100', '001', TO_DATE('2018-05-10', 'YYYY-MM-DD'), TO_DATE('2018-05-18', 'YYYY-MM-DD'), '7', 'U001', '35');
insert into units_leased (id, renterid, rentfrom, rentto, priceperunit, unitid, totalprice) values ('101', '002', TO_DATE('2018-06-01', 'YYYY-MM-DD'), TO_DATE('2018-06-04', 'YYYY-MM-DD'), '3', 'U011', '10');
insert into units_leased (id, renterid, rentfrom, rentto, priceperunit, unitid, totalprice) values ('102', '002', TO_DATE('2018-05-31', 'YYYY-MM-DD'), TO_DATE('2018-06-05', 'YYYY-MM-DD'), '2', 'U009', '10');
insert into units_leased (id, renterid, rentfrom, rentto, priceperunit, unitid, totalprice) values ('103', '003', TO_DATE('2018-05-26', 'YYYY-MM-DD'), TO_DATE('2018-05-27', 'YYYY-MM-DD'), '10', 'U005', '10');
insert into units_leased (id, renterid, rentfrom, rentto, priceperunit, unitid, totalprice) values ('104', '004', TO_DATE('2018-05-10', 'YYYY-MM-DD'), TO_DATE('2018-05-12', 'YYYY-MM-DD'), '7', 'U001', '20');
insert into units_leased (id, renterid, rentfrom, rentto, priceperunit, unitid, totalprice) values ('105', '002', TO_DATE('2018-05-20', 'YYYY-MM-DD'), TO_DATE('2018-05-24', 'YYYY-MM-DD'), '3', 'U011', '10');
